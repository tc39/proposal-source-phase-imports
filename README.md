...
As explained in the motivation, supporting a `"wasm-module"` evaluator attribute is a driving use case for this specificatoin in order to change the behaviour of
